  ...
  return (
    <div>
      ...
      <div className="app-container">
       ...
       <Card sx={{ padding: '30px 15px', backgroundColor:'#182638' ,color: 'white', backgroundImage:`linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url(${bg})`, backgroundRepeat:'no-repeat', backgroundPosition:'center', objectFit:'cover', backgroundSize:'cover'}}>
        <div className="row d-flex justify-content-center align-items-center">
            ...
            <div className="p-6 mt-5 rounded-lg shadow-lg w-full max-w-md mx-auto">
              ...
              <p className="mb-1">1. Read each question carefully.</p>
